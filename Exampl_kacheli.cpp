...
int main()
    ...
    txTextOut (150, 100, "–исование качели с разными параметрами");

    KacheliDraw (150, 250, 1, 1, 0, TX_DARKGRAY);
    txSelectFont ("Arial", 20);
    txTextOut (30, 280, " ачели: параметры размера x = 1, y = 1, качели не двигаютс€");

    KacheliDraw (650, 250, 1.5, 1.5, 0, TX_DARKGRAY);
    txTextOut (530, 290, " ачели: параметры размера x = 1.5, y = 1.5, качели не двигаютс€");
    ...
    txTextOut (290, 455, " ачели должны двигатьс€, но что-то пошло не так :(");
